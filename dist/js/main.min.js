...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_anmite__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_anmite___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__components_anmite__);
/**
 * @file 前端路由
 * @author v_gengsiyu
 * @date 2019-08-26
...
/* harmony default export */ __webpack_exports__["a"] = ({
    ...
    routes: [{
        path: '/',
        component: __WEBPACK_IMPORTED_MODULE_0__components_anmite___default.a,
        breadcrumbName: '斗兽棋'
    }, ]
});
...
/* harmony default export */ __webpack_exports__["a"] = (window.UF({
    appName: 'oms-app',
}));
 ...
 * Created by gengsiyu
 */
!(__WEBPACK_AMD_DEFINE_RESULT__ = function (uf, require) {
    // 生成随机数
    function random(max) {
    ...
    function checkCanEat() {
        ...
        if (!canEat) {
            !(function webpackMissingModule() { var e = new Error("Cannot find module \".\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()).message.error('太远了，吃不到~');
            reset();
            return;
        }
        ...
        if (curIdx.item.type === nextIdx.item.type) {
            !(function webpackMissingModule() { var e = new Error("Cannot find module \".\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()).message.info('不能大义灭亲~');
        } else {
            if ((cur > next && (cur !== 8 && next !== 1)) || (cur === 1 && next === 8)) {
                eat();
            } else if ((cur === 8 && next === 1) || (cur < next)) {
                !(function webpackMissingModule() { var e = new Error("Cannot find module \".\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()).message.info('倒反天罡！');
            } else if (cur === next) {
                eat('both');
                console.log('同归于尽');
            } else {
    ...
    function checkCur() {
        ...
        __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"curAuthor\""); e.code = 'MODULE_NOT_FOUND'; throw e; }())).set({
            content: text
        })
    }
    // 判断胜利
    function checkWiner(next) {
        ...
        if (redWiner) {
            __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"winer\""); e.code = 'MODULE_NOT_FOUND'; throw e; }())).set({
                content: '红方'
            });
        }
        if (blueWiner) {
                ...
                if (!e.target.innerHTML && !check) {
                    ...
                    if (!curIdx) {
                        if (check && !e.target.innerHTML) {
                            !(function webpackMissingModule() { var e = new Error("Cannot find module \".\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()).message.error('点了个寂寞~');
                            reset();
                            return;
                        }
                        if (type && type !== curColor) {
                            !(function webpackMissingModule() { var e = new Error("Cannot find module \".\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()).message.info('不该你走！');
                            reset();
                            return;
                        }
    ...
    return {
        ...
        afterCreate: e => {
            ...
            __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"anmites\""); e.code = 'MODULE_NOT_FOUND'; throw e; }())).set({
                content: ''
            });
            setTimeout(() => {
                __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"anmites\""); e.code = 'MODULE_NOT_FOUND'; throw e; }())).set({
            ...
            !(function webpackMissingModule() { var e = new Error("Cannot find module \".\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()).Modal.confirm({
                title: '规则说明',
                width: 800,
                content: {
                    type: 'div',
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__route_js__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__uf_js__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__css_index_less__ = __webpack_require__(1);
...
__WEBPACK_IMPORTED_MODULE_1__uf_js__["a" /* default */].config({
    appName: 'oms-app',
});

__WEBPACK_IMPORTED_MODULE_1__uf_js__["a" /* default */].init(__WEBPACK_IMPORTED_MODULE_0__route_js__["a" /* default */], '#oms-app');
